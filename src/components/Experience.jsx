      ...
      <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
        ...
        <ul className='w-full flex flex-col items-center justify-between ml-4 xs:ml-2'>
          <Details
            ...
            company='H2H Agri & Food'
            companyLink='https://www.linkedin.com/company/h2h-agrifood/'
            time='2023-Present'
            address='Buenos Aires'
            work="Working on developing an innovative application using Next.js and Tailwind. My main focus is creating a functional and visually appealing user interface. I collaborate closely with designers, backend developers, and other professionals to achieve an exceptional user experience."
          />
          <Details
            position='WordPress'
            company='Freelance'
