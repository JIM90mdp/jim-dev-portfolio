        ...
        <Layout className="pt-16">
          ...
          <div className="col-span-12">
            <div className="col-span-12 mb-10">
              <FeaturedProject
                type="TypeScript - React - Next.Js - Tailwind"
                title="Colonia de Verano Fasta - MDA"
                summary="Web application developed for Fasta San Vicente de Paul School in Mar del Plata and its summer camp project."
                img={project5}
                link="https://verano-fasta-mda.com/"
                github="/"
              />
            </div>
            ...
            <div className="col-span-12 mb-10">
              <FeaturedProject
                type="JavaScript - React - Next.Js - Css.modules"
                title="MMC - Servicios Legales"
                summary="Web application for a lawyer customer, allowing users to learn about the legal services provided, submit free legal inquiries, and access information related to legal services"
                img={project2}
            ...
            <div className="col-span-12  mb-10">
              <FeaturedProject
                type="Python - MongoDb - Django"
                title="Song-Challenge"
                summary="Application that challenges musicians&#39; creativity by generating random prompts for composing music."
                img={project1}
            ...
            <div className="col-span-12 mb-10">
              <FeaturedProject
                type="JavaScript - Node.Js - Express - Sequelize - PostgreSQL - React - Redux - React Admin - MaterialUI "
            ...
            <div className="col-span-12 mb-10">
              <FeaturedProject
                type="JavaScript - Node.Js - Express - Sequelize - PostgreSQL - React - Redux - CSS "
                title="JIM Countries"
                summary="The purpose of J.I.M+'s Countries website application is to provide information about all countries in the world and create activities, making the tourist trip planning easier. The information is provided by RESTful Application Program Interface restcountries.com."
                img={project4}
